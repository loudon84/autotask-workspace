"""Build + publish demo-portal scan 1.0.2 (OCR login, no filename map)."""
    ...
    with httpx.Client(timeout=60.0, trust_env=False) as client:
        with ZIP.open("rb") as fh:
            resp = client.post(
                ...
                data={"scope": "GLOBAL", "description": f"{FLOW_ID} {VERSION} demo OCR"},
            )
        ...
        pub = client.post(
            ...
            json={"reason": f"publish {FLOW_ID} {VERSION} demo OCR"},
        )
