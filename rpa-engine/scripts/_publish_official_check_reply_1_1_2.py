"""Build + publish official-portal check-reply 1.1.2.
    ...
    with httpx.Client(timeout=60.0, trust_env=False) as client:
        with ZIP.open("rb") as fh:
            resp = client.post(
                ...
                data={
                    "scope": "GLOBAL",
                    "description": f"{FLOW_ID} {VERSION} official portal check reply",
                },
            )
        ...
        pub = client.post(
            ...
            json={"reason": f"publish {FLOW_ID} {VERSION} official check reply"},
        )
        ...
        out = {
            ...
            "workflowCode": "srm_check_reply_status",
        }
