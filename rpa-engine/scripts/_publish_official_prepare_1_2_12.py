"""Build + publish official-portal prepare ERP order 1.2.20.
    ...
    with httpx.Client(timeout=60.0, trust_env=False) as client:
        with ZIP.open("rb") as fh:
            resp = client.post(
                ...
                data={
                    "scope": "GLOBAL",
                    "description": f"{FLOW_ID} {VERSION} official prepare; ctx.http ERP call logs",
                },
            )
        ...
        pub = client.post(
            ...
            json={"reason": f"publish {FLOW_ID} {VERSION} official prepare"},
        )
        ...
        out = {
            ...
            "workflowCode": "srm_prepare_erp_order",
        }
