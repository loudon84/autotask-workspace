"""Build + publish official-portal receipt query 1.1.3.

Start time 00:00:00, end time 23:59:59. Do not bind to demo portals.
"""
    ...
    with httpx.Client(timeout=60.0, trust_env=False) as client:
        with ZIP.open("rb") as fh:
            resp = client.post(
                ...
                data={
                    "scope": "GLOBAL",
                    "description": f"{FLOW_ID} {VERSION} start 00:00:00 end 23:59:59",
                },
            )
        ...
        pub = client.post(
            ...
            json={"reason": f"publish {FLOW_ID} {VERSION} start midnight end last second"},
        )
