"""Build + publish official-portal scan 1.1.3 (Binding searches, no default PO).
    ...
    with httpx.Client(timeout=60.0, trust_env=False) as client:
        with ZIP.open("rb") as fh:
            resp = client.post(
                ...
                data={
                    "scope": "GLOBAL",
                    "description": f"{FLOW_ID} {VERSION} official scan Binding searches",
                },
            )
        ...
        pub = client.post(
            ...
            json={"reason": f"publish {FLOW_ID} {VERSION} official scan Binding searches"},
        )
        ...
        out = {
            ...
            "workflowCode": "srm_scan_pending_orders",
        }
