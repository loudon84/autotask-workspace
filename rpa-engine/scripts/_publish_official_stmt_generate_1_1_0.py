"""Build + publish official-portal statement generate 1.1.0.

Locate 生成对账单; dryRun skips the click. Do not bind to demo portals.
"""
    ...
    with httpx.Client(timeout=60.0, trust_env=False) as client:
        with ZIP.open("rb") as fh:
            resp = client.post(
                ...
                data={
                    "scope": "GLOBAL",
                    "description": f"{FLOW_ID} {VERSION} official locate generate dryRun",
                },
            )
        ...
        pub = client.post(
            ...
            json={"reason": f"publish {FLOW_ID} {VERSION} official generate locate-only"},
        )
