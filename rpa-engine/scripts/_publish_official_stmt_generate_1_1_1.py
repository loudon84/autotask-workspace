"""Build + publish official-portal statement generate 1.1.1.

Header select-all + count check. dryRun skips the generate click.
"""
    ...
    with httpx.Client(timeout=60.0, trust_env=False) as client:
        ...
        with ZIP.open("rb") as fh:
            resp = client.post(
                ...
                data={
                    "scope": "GLOBAL",
                    "description": f"{FLOW_ID} {VERSION} official select-all count check dryRun",
                },
            )
