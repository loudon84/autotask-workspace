"""Build + publish official-portal statement submit review 1.1.0.

Scan invoices for real; dryRun skips 提交审核 click. Do not bind to demo portals.
"""
    ...
    with httpx.Client(timeout=60.0, trust_env=False) as client:
        with ZIP.open("rb") as fh:
            resp = client.post(
                ...
                data={
                    "scope": "GLOBAL",
                    "description": f"{FLOW_ID} {VERSION} official scan invoice locate submit dryRun",
                },
            )
        ...
        pub = client.post(
            ...
            json={"reason": f"publish {FLOW_ID} {VERSION} official submit locate-only"},
        )
        ...
        out = {
            ...
            "workflowCode": "srm_stmt_submit_review",
        }
