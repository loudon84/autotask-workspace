"""Build + publish official-portal statement submit review 1.1.1.

Second scan must match verified page invoice fields. dryRun skips 提交审核 click.
"""
    ...
    with httpx.Client(timeout=60.0, trust_env=False) as client:
        with ZIP.open("rb") as fh:
            resp = client.post(
                ...
                data={
                    "scope": "GLOBAL",
                    "description": f"{FLOW_ID} {VERSION} official rescan match then locate submit",
                },
            )
