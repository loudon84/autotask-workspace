"""Build + publish official-portal statement submit review 1.1.3.

dryRun uses Playwright trial click on 提交审核; does not perform the real click.
"""
    ...
    with httpx.Client(timeout=60.0, trust_env=False) as client:
        with ZIP.open("rb") as fh:
            resp = client.post(
                ...
                data={
                    "scope": "GLOBAL",
                    "description": f"{FLOW_ID} {VERSION} official submit trial-click dryRun",
                },
            )
        ...
        pub = client.post(
            ...
            json={"reason": f"publish {FLOW_ID} {VERSION} official submit trial-click dryRun"},
        )
