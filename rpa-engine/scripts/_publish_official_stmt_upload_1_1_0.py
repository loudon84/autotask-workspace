"""Build + publish official-portal statement upload invoice 1.1.0.

First scan for Client verification. Do not click 提交审核. Do not bind to demo.
"""
    ...
    with httpx.Client(timeout=60.0, trust_env=False) as client:
        with ZIP.open("rb") as fh:
            resp = client.post(
                ...
                data={
                    "scope": "GLOBAL",
                    "description": f"{FLOW_ID} {VERSION} official scan invoice for Client verify",
                },
            )
