"""Build + publish official-portal statement upload invoice 1.1.2.

Fix invalid CSS :visible in invoice-field JS. Retry leaves payable page first.
"""
    ...
    with httpx.Client(timeout=60.0, trust_env=False) as client:
        with ZIP.open("rb") as fh:
            resp = client.post(
                ...
                data={
                    "scope": "GLOBAL",
                    "description": f"{FLOW_ID} {VERSION} official scan invoice css+retry list",
                },
            )
        ...
        pub = client.post(
            ...
            json={"reason": f"publish {FLOW_ID} {VERSION} official invoice scan"},
        )
        ...
        out = {
            ...
            "workflowCode": "srm_stmt_upload_invoice",
        }
