"""Build + publish prepare_erp_order 1.2.10 (demo-portal package) to Engine Registry."""
...
SRC = FLOWS / "rpa_flow_supplier_portal_prepare_erp_order" / "1.2.10"
DIST = FLOWS / "dist"
    ...
    with httpx.Client(timeout=60.0, trust_env=False) as client:
        with ZIP.open("rb") as fh:
            resp = client.post(
                ...
                data={"scope": "GLOBAL", "description": f"{FLOW_ID} {VERSION} (demo portal)"},
            )
        ...
        pub = client.post(
            ...
            json={"reason": f"publish {FLOW_ID} {VERSION} demo-portal"},
        )
        ...
        vb = client.post(
            ...
            headers={**HEADERS, "Content-Type": "application/json"},
            json={"rpaFlowId": FLOW_ID, "rpaFlowVersion": out["rpaFlowVersion"], "workflowCode": "srm_prepare_erp_order"},
        )
