...
SPEC = importlib.util.spec_from_file_location(
    "srm_stmt_upload_invoice_flow_1_1_2",
    FLOW_DIR / "flow.py",
)
...
class OfficialPackageGuardTests(unittest.TestCase):
    def test_manifest_is_1_1_2_upload(self):
