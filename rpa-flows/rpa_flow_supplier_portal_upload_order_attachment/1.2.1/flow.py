...
ATTACHMENT_UPLOAD_URL = (
    "http://192.168.99.111:8080/core/api/srm/so/uploadAttachment"
)
...
ATTACHMENT_UPLOAD_URL_VALUE = "http://api.doc.uat.smart-core.com.hk/upload"
...
def _local_upload_record(attachment_name, source_file_name, size):
    return {
        "attachmentId": "",
...
class AttachmentSystemClient:
    def __init__(self, *, transport=None, client_id=None, client_secret=None):
        ...
        try:
            response = await self._active_client().post(
                ...
                data={
                    ...
                    "uploadUrl": ATTACHMENT_UPLOAD_URL_VALUE,
                },
                files={
                    "file": (
                        source_file_name,
