...
SPEC = importlib.util.spec_from_file_location(
    "supplier_portal_upload_order_attachment_flow_1_3_1",
    FLOW_DIR / "flow.py",
)
...
class VerifySignedOfficialTests(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_reads_reply_status_from_list_column(self):
        adapter = self._adapter({}, evaluate_result="已回签")
        self.assertEqual(await adapter._read_list_reply_status(PO_NO), "已回签")
