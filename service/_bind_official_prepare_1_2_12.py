"""Bind official-portal prepare ERP order 1.2.20 to 天地伟业-芯云-正式演练.

Does not change demo-portal prepare bindings (1.2.11).
Does not set dryRun: this Flow writes our SDMS/ERP.
"""
...
EXPECTED_VERSION = "1.2.20"
PUBLISH_JSON = Path(
    r"d:\work_space260811\autotask-workspace\rpa-flows"
    r"\rpa_flow_supplier_portal_prepare_erp_order\_publish_1.2.20.json"
)
...
async def main() -> None:
    ...
    async with async_session_factory() as db:
        ...
        print("demo prepare bindings unchanged")
