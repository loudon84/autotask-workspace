"""Switch official-portal receipt query Binding to 1.1.3. Does not change demo 1.0.x."""
...
PUBLISH = Path(
    r"d:\work_space260811\autotask-workspace\rpa-flows\rpa_flow_srm_stmt_query_receipts\_publish_1.1.3.json"
)
