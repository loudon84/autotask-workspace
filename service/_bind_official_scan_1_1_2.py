"""Switch official-portal scan Binding to 1.1.2. Does not change demo 1.0.x."""
...
PUBLISH = Path(
    r"d:\work_space260811\autotask-workspace\rpa-flows\rpa_flow_srm_scan_pending_orders\_publish_1.1.2.json"
)
