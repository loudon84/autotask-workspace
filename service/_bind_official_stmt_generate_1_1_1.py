"""Bind official statement generate 1.1.1 with dryRun=true.

Updates rehearsal portals on supplier.tiandy.com (name contains 演练).
Does not change demo 1.0.x or production portal 天地伟业-芯云.
"""
...
PUBLISH_JSON = Path(
    ...
    r"\rpa_flow_srm_stmt_generate\_publish_1.1.1.json"
)
...
async def main() -> None:
    ...
    if "rpa_autotask" in db:
        raise SystemExit("refusing to bind against rpa_autotask; use 测库 .env / unset DATABASE_URL")
