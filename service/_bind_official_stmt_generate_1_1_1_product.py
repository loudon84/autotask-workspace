"""Bind production portal 天地伟业-芯云 to generate 1.1.1 without dryRun.
...
PUBLISH_JSON = Path(
    ...
    r"\rpa_flow_srm_stmt_generate\_publish_1.1.1.product.json"
)
...
async def main() -> None:
    ...
    if version_id == "55637e52-a893-4f29-a5c8-89235effbd10":
