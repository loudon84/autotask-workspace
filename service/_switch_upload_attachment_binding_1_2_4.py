"""Switch srm_upload_order_attachment binding to 1.2.4 for 天地伟业 portals."""
...
PUBLISH = Path(r"d:\work_space260811\autotask-workspace\rpa-flows\rpa_flow_supplier_portal_upload_order_attachment\_publish_1.2.4.json")
    ...
    async with async_session_factory() as db:
        ...
        bindings = (
            await db.execute(
                ...
                .where(
                    WorkflowTemplate.code == WORKFLOW_CODE,
