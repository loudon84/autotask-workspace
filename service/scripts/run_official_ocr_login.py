"""Load official portal credentials and run OCR login probe. Does not print the password."""
...
PROBE = Path(r"d:\work_space260811\autotask-workspace\rpa-engine\scripts\_probe_official_ocr_login.py")
